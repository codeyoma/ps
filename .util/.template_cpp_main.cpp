...
void _run_test(const int problem_number, const int test_number) {
  string test_input_file_name = "boj/" + to_string(problem_number) + "/t_" +
                                to_string(test_number) + "_input.txt";
  string my_output_file_name = "boj/" + to_string(problem_number) + "/t_" +
                               to_string(test_number) + "_output_mine.txt";
